  ...
  return (
    ...
    >
        ...
        <View className="bg-white px-8 pb-10 pt-16 rounded-b-[4rem] shadow-sm shadow-slate-200">
           <View className="flex-row justify-between items-start mb-8">
              <View>
                 ...
                 {profileData?.bio && (
                    <Text className="text-slate-500 font-medium text-xs mt-3 leading-5 pr-4" numberOfLines={2}>
                       {profileData.bio}
                    </Text>
                 )}
                 ...
                 <Pressable 
                    ...
                    className="mt-4 bg-slate-100 px-4 py-2 rounded-xl self-start border border-slate-200"
                 >
                    <Text className="text-slate-700 font-bold text-[10px] uppercase tracking-widest">Edit Profile</Text>
                 </Pressable>
              </View>
        ...
        <View className="px-6 mt-8">
           ...
           <ProfileItem icon={Info} label="Help Center & Support" onPress={() => Alert.alert('Support', 'Contact us at support@supplylink.lk')} />
           <ProfileItem icon={ShieldCheck} label="Privacy Policy" onPress={() => Alert.alert('Privacy', 'Our privacy policy is available on our website.')} />
